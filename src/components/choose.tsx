...
const Choose = () => {
  return (
    <div className='relative pt-[50px] pb-[38px]'>
      ...
      <div className='max-w-[1480px] mx-auto '>
        <h2 className="font-bold text-[28px] md:text-[36px] xl:text-[40px] leading-[36px] sm:leading-[44px] lg:leading-[50px] text-center text-white pb-[40px] uppercase px-4 md:px-6 lg:px-8">
          Warum Sie uns wählen sollten
        </h2>

        {/* -----------------------------------cards wrapper----------------------------------- */}
        {/* relative => lines ka positioning-context; z-10 cards ki row/grid par hai taake lines ke upar dikhein */}
        <div className="relative px-10 md:px-0 lg:px-4">
          ...
          <div className="relative z-10 flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-row justify-center justify-items-center items-center gap-6 md:gap-8 lg:gap-10 xl:gap-17">
            ...
            {/* card 1 */}
            <div className="p-[3px] w-full h-[210px] md:w-[260px] md:h-[225px] lg:w-[270px] lg:h-[250px] xl:w-[290px] xl:h-[275px] rounded-[46px] bg-[linear-gradient(180deg,#081DFF_10%,#1980FB_35%,#000000_75%)]">
