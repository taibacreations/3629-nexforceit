...
const Banner = () => {
  ...
  return (
    <section id="heim" ref={sectionRef} className="bg-[url(/banner.webp)] bg-[position:50%_15%] lg:bg-cover bg-no-repeat min-h-[100vh] lg:min-h-[135vh]">
        <div className="pt-[23.7vh]">
            <div className="text-center max-w-[1180px] mx-auto px-4 md:px-6 xl:px-8">
              ...
              <button
                ...
                className="relative overflow-hidden text-[18px] sm:text-[20px] lg:text-[24px] button w-full sm:w-[280px] lg:w-[308px] h-[52px] sm:h-[55px] mt-[3.5vh]"
